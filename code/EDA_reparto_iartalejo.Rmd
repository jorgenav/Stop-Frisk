...
En cuanto a la **variable dependiente "perStop"**, la media de tiempo parado para cada grupo es muy similar. Aunque está medida se ve influenciada significativamente por los valores extremos. En contraste, se puede apreciar, sorprendentemente, que el valor de la mediana es bastante más alto en el caso de los no cacheados (46 min) que en el caso de los sí cacheados (35min).
...
En cuanto a la **variable dependiente "perStop"**, la media de tiempo parado en el caso de llevar un arma de otro tipo no catalogada es de casi 5 min inferior respecto a los otros casos. Aunque está medida se ve influenciada significativamente por los valores extremos. En contraste, se puede apreciar que el valor de la mediana es bastante más bajo (24min) en los casos donde sí fue encontrada un arma no catalogada que en los que no (46 min).
...
En cuanto a la **variable dependiente "perStop"**, la media de tiempo parado cuando el oficial de policía tuvo que apuntar con su arma al sospecho es de casi 6 min inferior respecto a los otros casos. Aunque está medida se ve influenciada significativamente por los valores extremos. En contraste, se puede apreciar que el valor de la mediana es bastante más bajo (24min) en los casos donde sí tuvo que apuntar con su arma al sospecho que en los que no (46 min).
...
En cuanto a la **variable dependiente "perStop"**, la media de tiempo parado en el caso de estar actuando como vigía es similar a los otros casos. También, se puede apreciar que el valor de la mediana es similar en los casos donde sí estaba el sospechoso actuando como un vigía como en los que no.
...
En cuanto a la **variable dependiente "perStop"**, la media de tiempo parado en el caso de llevar ropa usada frecuentemente en un crimen es similar a los otros casos. Aunque está medida se ve influenciada significativamente por los valores extremos. En contraste, se puede apreciar que el valor de la mediana es más bajo (35min) en los casos donde el sospechoso llevaba ropa usada frecuentemente en un crimen que en los casos donde no (46 min).
...
En cuanto a la **variable dependiente "perStop"**, la media de tiempo parado en el caso de ser cacheado por llevar un atuendo inapropiado para la estación del año en curso es similar a los otros casos. Aunque está medida se ve influenciada significativamente por los valores extremos. En contraste, se puede apreciar que el valor de la mediana es más bajo (35min) en los casos donde el sospechoso fue cacheado por llevar un atuendo inapropiado para la estación del año, que en los casos donde no (46 min).
...
En cuanto a la **variable dependiente "perStop"**, la media de tiempo parado en el caso de ser cacheado por cometer acciones relacionadas en un crimen violento es similar a los otros casos. Aunque está medida se ve influenciada significativamente por los valores extremos. En contraste, se puede apreciar que el valor de la mediana es más bajo (34min) en los casos donde el sospechoso fue cacheado por cometer acciones relacionadas en un crimen violento, que en los casos donde no (46 min).
...
En cuanto a la **variable dependiente "perStop"**, la media de tiempo parado es muy similar para los diferentes casos. Aunque está medida se ve influenciada significativamente por los valores extremos. En contraste, se puede apreciar que el valor de la mediana es más bajo (34min) en los casos donde el sospechoso fue registrado por las declaraciones manifestadas por el propio sospechoso, que en los casos donde no (46 min).
...
En cuanto a la **variable dependiente "perStop"**, la media de tiempo parado es muy similar para los diferentes casos. Aunque está medida se ve influenciada significativamente por los valores extremos. En contraste, se puede apreciar que el valor de la mediana es más bajo (34min) en los casos donde el sospechoso fue parado por percibirse señales o sonidos de actividad criminal, que en los casos donde no (46 min).
