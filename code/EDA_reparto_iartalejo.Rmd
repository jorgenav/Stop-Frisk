...
# EPSG Projection 2263 - NAD83 / New York Long Island (ftUS) > WGS 84 (a.k.a. EPSG:4326)
...
pal <- colorFactor(c("#984ea3", "#e41a1c"), df$arstmade)

leaflet(data = df) %>%
  addProviderTiles(providers$Esri.WorldGrayCanvas) %>%
  setView(-73.9796295, 40.6978522, zoom = 10) %>%
  addCircleMarkers(lng = ~df$xcoord, lat = ~df$ycoord, radius = 1, color= ~pal(df$arstmade)) %>%
  addLegend(position="bottomleft", colors=c("#e41a1c","#984ea3"), labels=c("arstmade (Yes)", "arstmade (No)"))
```
