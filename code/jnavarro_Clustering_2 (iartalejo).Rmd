...
##########################################################################################################
# Obtención de los índices de cada cluster
indices_train.cl.1 <- SQFdataTrain[which(SQFdataTrain$cluster == 1),] %>% row.names() %>% as.integer()
indices_train.cl.2 <- SQFdataTrain[which(SQFdataTrain$cluster == 2),] %>% row.names() %>% as.integer()
indices_train.cl.3 <- SQFdataTrain[which(SQFdataTrain$cluster == 3),] %>% row.names() %>% as.integer()
indices_train.cl.4 <- SQFdataTrain[which(SQFdataTrain$cluster == 4),] %>% row.names() %>% as.integer()
indices_train.cl.5 <- SQFdataTrain[which(SQFdataTrain$cluster == 5),] %>% row.names() %>% as.integer()
indices_train.cl.6 <- SQFdataTrain[which(SQFdataTrain$cluster == 6),] %>% row.names() %>% as.integer()
##########################################################################################################
