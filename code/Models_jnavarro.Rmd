...
# RANDOM FOREST CON CARET Y REJILLA
#==========================================================================================
# RF_grid <- expand.grid(mtry = seq(9,54,9))
...
confusionMatrix(predict(model_rf_10, SQFdataTest), SQFdataTest$arstmade, positive="Y")
confusionMatrix(predict(model_rf_25, SQFdataTest), SQFdataTest$arstmade, positive="Y")
confusionMatrix(predict(model_rf_50, SQFdataTest), SQFdataTest$arstmade, positive="Y")
confusionMatrix(predict(model_rf_75, SQFdataTest), SQFdataTest$arstmade, positive="Y")
confusionMatrix(predict(model_rf_120, SQFdataTest), SQFdataTest$arstmade, positive="Y")
confusionMatrix(predict(model_rf_200, SQFdataTest), SQFdataTest$arstmade, positive="Y")
