...
# Eliminación de variables con 20% de NAs pero nula varianza (casos pertenecientes todos a una misma clase).
...
# Eliminación de variables con demasiados niveles (strings)
...
SQFdata_modif %>% group_by(zip) %>%
    summarise(n())

# Eliminación de variables que no aparecen en el checkDataQuality
...
# Eliminación de factores con más de 53 niveles
