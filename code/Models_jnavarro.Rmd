...
SQFdata <- SQFdata[,-match(c("arstoffn", "sumoffen", "officrid", "offverb", "offshld", "forceuse", "othfeatr", "addrnum", "stname", "post", "beat"),colnames(SQFdata))]
...
checkDataQuality(SQFdataTest, out.file.num = drq.num,  out.file.cat = drq.cat)
...
```{r}
# Punto de partida
SQFdata %>% group_by(is.na(age)) %>%
    summarise(n())

SQFdata_modif <- SQFdata %>% filter(!is.na(age))
...
SQFdata_modif %>% filter(is.na(pistol)) %>%
    group_by(knifcuti, othrweap) %>%
...
summary(SQFdata_modif$pistol)
summary(SQFdata_modif$knifcuti)
summary(SQFdata_modif$othrweap)

summary(SQFdata_modif$pf_hands)
summary(SQFdata_modif$pf_wall)
summary(SQFdata_modif$pf_grnd)
summary(SQFdata_modif$pf_drwep)
summary(SQFdata_modif$pf_ptwep)
summary(SQFdata_modif$pf_hcuff)
summary(SQFdata_modif$pf_other)

summary(SQFdata_modif$ac_rept)
summary(SQFdata_modif$ac_inves)
summary(SQFdata_modif$rf_vcrim)
summary(SQFdata_modif$rf_othsw)
summary(SQFdata_modif$ac_proxm)
summary(SQFdata_modif$rf_attir)
summary(SQFdata_modif$cs_objcs)
summary(SQFdata_modif$cs_descr)
summary(SQFdata_modif$cs_casng)
summary(SQFdata_modif$cs_lkout)
summary(SQFdata_modif$rf_vcact)
summary(SQFdata_modif$cs_cloth)
summary(SQFdata_modif$cs_drgtr)
summary(SQFdata_modif$ac_evasv)
summary(SQFdata_modif$ac_assoc)
summary(SQFdata_modif$cs_furtv)
summary(SQFdata_modif$rf_rfcmp)
summary(SQFdata_modif$ac_cgdir)
summary(SQFdata_modif$rf_verbl)
summary(SQFdata_modif$cs_vcrim)
summary(SQFdata_modif$cs_bulge)
summary(SQFdata_modif$cs_other)
summary(SQFdata_modif$ac_incid)
summary(SQFdata_modif$ac_time)
summary(SQFdata_modif$rf_knowl)
summary(SQFdata_modif$ac_stsnd)
summary(SQFdata_modif$ac_other)
summary(SQFdata_modif$sb_hdobj)
summary(SQFdata_modif$sb_outln)
summary(SQFdata_modif$sb_admis)
summary(SQFdata_modif$sb_other)
summary(SQFdata_modif$rf_furt)
summary(SQFdata_modif$rf_bulg)

# Variables eliminadas
summary(SQFdata_modif$adtlrept)
summary(SQFdata_modif$riflshot)
summary(SQFdata_modif$asltweap)
summary(SQFdata_modif$machgun)
summary(SQFdata_modif$pf_baton)
summary(SQFdata_modif$pf_pepsp)
...
# Variables con strings como factores
summary(SQFdata_modif$premname)
summary(SQFdata_modif$stinter)
summary(SQFdata_modif$crossst)
summary(SQFdata_modif$sector)

# Variables que no aparecen en el checkDataQuality
summary(SQFdata_modif$state)
summary(SQFdata_modif$zip)
summary(SQFdata_modif$addrtyp)
summary(SQFdata_modif$rescode)
summary(SQFdata_modif$premtype)
summary(SQFdata_modif$aptnum)
summary(SQFdata_modif$timestop)

# Factores con maś de 53 niveles
levels(SQFdata_modif$pct)
levels(SQFdata_modif$crimsusp)
levels(SQFdata_modif$addrpct)
levels(SQFdata_modif$detailCM)

# Otras variables eliminadas
summary(SQFdata_modif$year)
summary(SQFdata_modif$datestop)
summary(SQFdata_modif$compyear)
summary(SQFdata_modif$comppct)
summary(SQFdata_modif$lineCM)
summary(SQFdata_modif$dob)

# Factores con menos de 2 niveles
summary(SQFdata_modif$dettypCM)

SQFdata_modif %>% group_by(dob == "1900-12-31") %>%
    summarise(n())

SQFdata %>% group_by(dob == "1900-12-31") %>%
    summarise(n())
...
SQFdata_modif <- SQFdata_modif[,-match(c("adtlrept", "riflshot", "asltweap", "machgun", "pf_baton", "pf_pepsp", "xcoord", "ycoord", "premname", "sector", "stinter", "crossst", "state", "zip", "addrtyp", "rescode", "premtype", "aptnum", "timestop", "pct", "crimsusp", "addrpct", "detailCM","year","datestop","compyear","comppct","lineCM","dob", "dettypCM"),colnames(SQFdata_modif))]

dim(SQFdata_modif)


# Factores con menos de 2 niveles -> Eliminar
SQFdata_modif <- SQFdata[,-c(which(sapply(X = SQFdata, fun) < 2))]
...
SQFdata <- SQFdata[,-c(which(sapply(SQFdata, fun_v2) < 2))]

sapply(SQFdata_modif, fun)
sapply(SQFdata_modif, fun_v2) < 2

dim(SQFdata)
dim(SQFdata_modif)

dim(SQFdata[,-c(which(sapply(SQFdata, fun) < 2))])
dim(SQFdata_modif[,-c(which(sapply(SQFdata_modif, fun) < 2))])

dim(SQFdata[,-c(which(sapply(SQFdata, fun_v2) < 2))])
dim(SQFdata_modif[,-c(which(sapply(SQFdata_modif, fun_v2) < 2))])

SQFdata <- SQFdata[,-c(which(sapply(SQFdata, fun_v2) < 2))]

nearZeroVar(SQFdata_modif)

# dim(SQFdata_modif)

dim(SQFdata_modif[-nearZeroVar(SQFdata_modif)])
...
Es decir, en el caso que nos ocupa, la clase negativa son 4842 casos y la positiva 27060. Nos interesa que ambas clases posean el mismo número de casos, por lo que la clase negativa tendrá que ser ampliada en 27060/4842 = 5.588 = 4.588 casos por cada caso que existe.
...
Sabemos que para este caso debemos añadir 4.588 casos por caso en la clase minoritaria, perc.over se fija a 400 y se calcula el número de casos que se han de seleccionar de la clase mayoritaria en base al número de casos añadidos. Se añaden 4*4842 = 19368 casos, por lo que en la clase minoritaria quedarán finalmente 19368 + 4842 = 24210 casos. Queremos que la clase mayoritaria alcance ese mismo número de casos, por lo que habrá que seleccionar *X* casos por cada caso añadido a la clase minoritaria:
...
```{r}
set.seed(123456)
train = sample(1:dim(SQFdata_modif)[1], dim(SQFdata_modif)[1] * 0.7)
SQFdataTrain = SQFdata_modif[train, ]
SQFdataTest = SQFdata_modif[-train, ]
dim(SQFdataTrain)
dim(SQFdataTest)
...
newSQFdataTrain <- SMOTE(arstmade ~ ., data=SQFdataTrain, k = 10, perc.over = 400, perc.under = 125)

newSQFdataTrain %>% group_by(arstmade) %>%
    summarise(count = n()) %>%
    mutate(percent = 100*count/sum(count))

```

## Regresión lineal: perstop -> NO APLICA
...
model_glm_SMOTE <- glm(arstmade ~ ., data = newSQFdataTrain, family = "binomial")
summary(model_glm_SMOTE)

dim(SQFdataTrain)
dim(newSQFdataTrain)


pred <- predict(model_glm, SQFdataTest, type = "response")
confusionMatrix(factor(pred > 0.5, levels = c(FALSE, TRUE), labels = c("N","Y")), SQFdataTest$arstmade, positive = "Y")

pred_SMOTE <- predict(model_glm_SMOTE, SQFdataTest, type = "response")
confusionMatrix(factor(pred_SMOTE > 0.5, levels = c(FALSE, TRUE), labels = c("N","Y")), SQFdataTest$arstmade, positive = "Y")
...
model_glm <- foreach(ntree=rep(100, 6), .combine=combine, .multicombine=TRUE) %dopar% {
    glm(arstmade ~ ., data = SQFdataTrain, family="binomial")
}

model_glm <- glm(arstmade ~ race + recstat + inout, data = SQFdataTrain, na.action = na.omit, family = "binomial")

model_glm_Vacio = glm(arstmade ~ 1, data = SQFdataTrain, family = "binomial")
summary(model_glm_Vacio)


registerDoMC(cores = 8)

train_control <- trainControl(allowParallel = TRUE)
model_glm_Completo <- train(arstmade ~ ., data=SQFdataTrain, trControl=train_control, method = "polr", na.action = na.omit)
