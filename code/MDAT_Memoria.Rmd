...
length(is.na(SQFdata$officrid))


# Eliminación de variables con nula varianza (casos pertenecientes
...
# Eliminación de variables que no aparecen en el checkDataQuality -> Todo NAs. 6 variables eliminadas.
summary(SQFdata_modif$state);summary(SQFdata_modif$zip);
...
SQFdata_modif <- SQFdata_modif %>%
                    select(-c(state,zip,rescode,premtype,aptnum,timestop))
