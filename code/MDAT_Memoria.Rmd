...
## 5. Redes neuronales
### 5.1 Recodificación variables con categorías desbalanceadas o sin registros
```{r}
...
### 5.2 Eliminación de variables relacionadas con el registro
...
### 5.3 Tratamiento previo a las variables
...
### 5.4 División de muestra en train y test
...
### 5.5 Ajuste del desbalanceo: Down-sampling
...
### 5.6 Escalamiento datos de entrenamiento
```{r}
...
### 5.2.3 SVM
```{r}
predSVM=prediction(as.numeric(svm.test.linear),as.numeric(SQFdataTest$arstmade))
